package xyz.tobebetter.controller.check;
...
/**
 * Created by zhuleqi on 2018/12/4.
 */

@Controller
@RequestMapping("/wechatCheck")
public class WeChatCheckController {
    private static String WECHAT_TOKEN = "leqisoft";
    ...
    public void check(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (WeChatCheckController.checkSignature(signature, timestamp, nonce)) {
            out.print(echostr);
        }
        out.close();
        out = null;
